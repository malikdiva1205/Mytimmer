...
const RANK_COLORS = ['#9180c8', '#d4895a', '#5faa86'];
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            <section>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '18px' }}>
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: 'rgba(145,128,200,0.1)', border: '1px solid rgba(145,128,200,0.25)', borderRadius: '50px', padding: '4px 14px', fontSize: '0.71rem', color: '#9180c8', fontWeight: 600 }}>
