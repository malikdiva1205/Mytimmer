...
const RANK_COLORS = ['#a090d8', '#e0955a', '#5faa86'];
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            <section>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '6px' }}>
                <TrophyIcon size={20} color="#a090d8" />
                <h2 style={{ fontFamily: 'Sofia, cursive', fontSize: '1.6rem', color: 'var(--text-dark)', margin: 0 }}>
                  Weekly Podium
                </h2>
              </div>
              <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '18px' }}>
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: 'rgba(160,144,216,0.1)', border: '1px solid rgba(160,144,216,0.25)', borderRadius: '50px', padding: '4px 14px', fontSize: '0.71rem', color: '#a090d8', fontWeight: 600 }}>
                  <ClockIcon size={11} color="#a090d8" />
